...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        list2.add("country=[can not be null]");
        Map<String, List<String>> expected2 = Map.of("country", list2);
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address("Russia", "Ufa", "1-st street", "5", "1");
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        List<String> list3 = new ArrayList<>();
        list3.add("city=[length less than 4]");
        Map<String, List<String>> expected3 = Map.of("city", list3);
        assertThat(result3).isEqualTo(expected3);
    }
    // END
}
